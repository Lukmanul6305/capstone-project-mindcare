...
import { journalSchema, updateJournalSchema } from "../validations/journalValidation.js";
...
journalRouter.put("/:id", verifyToken, validate(updateJournalSchema), journalController.updateJournal);
