...
const RegisterStep2Biodata = ({ form, onChange }) => {
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <label htmlFor="bio-pekerjaan" className="text-sm font-bold text-[#1E293B] flex items-center gap-2">
          <FiBriefcase className="text-pink-500" size={16} />
          Pekerjaan
        </label>
        <select
          id="bio-pekerjaan"
          ...
          onChange={onChange}
          className="w-full rounded-2xl border-2 border-[#1E293B] bg-[#FFFDF5] px-4 py-3 font-medium text-[#1E293B] focus:outline-none focus:border-[#8B5CF6] focus:shadow-[4px_4px_0px_0px_#8B5CF6] transition-all duration-200"
        >
